	...
	M.init=function(div)
	{
		...
		M.gods={
			...
			'order':{
				...
				desc3:'<span class="green">'+loc("Sugar lumps ripen <b>%1</b> sooner.",Game.sayTime(60*20*Game.fps))+'</span>'+'<span class="red">'+'</span>', //loc("If the effect is inactive, Sugar lumps take %1% longer to ripen.",Game.sayTime(60*20*Game.fps))+
